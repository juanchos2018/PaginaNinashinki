...
var add = __webpack_require__(5).default
module.exports.__inject__ = function (context) {
  add("4ee2cbcc", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Espacio_vue_vue_type_style_index_0_id_484eceea_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(317);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Espacio_vue_vue_type_style_index_0_id_484eceea_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Espacio_vue_vue_type_style_index_0_id_484eceea_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Espacio_vue_vue_type_style_index_0_id_484eceea_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Espacio_vue_vue_type_style_index_0_id_484eceea_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_vue_loader_lib_index_js_vue_loader_options_Espacio_vue_vue_type_style_index_0_id_484eceea_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".use-text-title[data-v-484eceea]{font-weight:var(--font-bold);font-size:48px;line-height:72px}@media(max-width:1279px){.use-text-title[data-v-484eceea]{font-size:38px;line-height:60px}}@media(max-width:599px){.use-text-title[data-v-484eceea]{font-size:28px;line-height:44px}}.use-text-title2[data-v-484eceea]{font-size:36px;line-height:56px;font-weight:var(--font-bold)}@media(max-width:1279px){.use-text-title2[data-v-484eceea]{font-size:32px;line-height:48px}}@media(max-width:599px){.use-text-title2[data-v-484eceea]{font-size:24px;line-height:36px}}.use-text-subtitle[data-v-484eceea]{font-weight:var(--font-medium);font-size:28px;line-height:44px}@media(max-width:1279px){.use-text-subtitle[data-v-484eceea]{font-size:24px;line-height:36px}}@media(max-width:599px){.use-text-subtitle[data-v-484eceea]{font-size:18px;line-height:28px}}.use-text-subtitle2[data-v-484eceea]{font-weight:var(--font-regular);font-size:22px;line-height:32px}@media(max-width:1279px){.use-text-subtitle2[data-v-484eceea]{font-size:20px;line-height:32px}}@media(max-width:599px){.use-text-subtitle2[data-v-484eceea]{font-size:16px;line-height:24px}}.use-text-caption[data-v-484eceea],.use-text-paragraph[data-v-484eceea]{font-weight:var(--font-regular);font-size:16px;line-height:24px}@media(max-width:599px){.use-text-caption[data-v-484eceea]{font-size:14px;line-height:22px}}@media(max-width:1919px){.use-hidden-lg-down[data-v-484eceea]{display:none!important}}@media(max-width:1279px){.use-hidden-md-down[data-v-484eceea]{display:none!important}}@media(max-width:959px){.use-hidden-sm-down[data-v-484eceea]{display:none!important}}@media(max-width:599px){.use-hidden-xs-down[data-v-484eceea]{display:none!important}}@media(min-width:1280px){.use-hidden-lg-up[data-v-484eceea]{display:none!important}}@media(min-width:960px){.use-hidden-md-up[data-v-484eceea]{display:none!important}}@media(min-width:600px){.use-hidden-sm-up[data-v-484eceea]{display:none!important}}.root1[data-v-484eceea]{background:url(/images/agency/bg-pattern.png) repeat var(--v-primarydark-base);background-size:10%;position:relative;color:#fff;padding:80px 0}@media(max-width:599px){.root1[data-v-484eceea]{text-align:center;padding:24px 0}}.root1 p[data-v-484eceea]{margin-bottom:40px}.root1 .v-btn.white[data-v-484eceea]{min-width:180px;font-size:18px;color:var(--v-primarydark-base)!important}.root[data-v-484eceea]{background:url(/images/agency/bg-pattern.png) repeat var(--v-primarydark-base);background-size:10%;position:relative;color:#fff;padding:80px 0}@media(max-width:599px){.root[data-v-484eceea]{text-align:center;padding:24px 0}}.root p[data-v-484eceea]{margin-bottom:40px}.root .v-btn.white[data-v-484eceea]{min-width:180px;font-size:18px;color:var(--v-primarydark-base)!important}.illu-wrap[data-v-484eceea]{position:static}@media(max-width:959px){.illu-wrap[data-v-484eceea]{display:none}}.illustration[data-v-484eceea]{margin-top:20px;box-shadow:0 0 18px 0 rgba(0,0,0,.17);position:absolute;border:15px solid var(--v-primary-base);background:var(--v-primary-base);border-radius:25px;transform:rotate(45deg);overflow:hidden}.illustration img[data-v-484eceea]{height:105%}.v-application--is-ltr .illustration img[data-v-484eceea]{transform:translateX(-20%) rotate(-45deg) scale(1.3)}.v-application--is-rtl .illustration img[data-v-484eceea]{transform:translateX(20%) rotate(-45deg) scale(1.3)}.illustration.one[data-v-484eceea]{border-radius:15px;width:60px;height:60px;top:-10px}[dir=ltr] .illustration.one[data-v-484eceea]{left:100px}[dir=rtl] .illustration.one[data-v-484eceea]{right:100px}.illustration.two[data-v-484eceea]{width:180px;height:180px;top:-10px}[dir=ltr] .illustration.two[data-v-484eceea]{left:300px}[dir=rtl] .illustration.two[data-v-484eceea]{right:300px}.illustration.three[data-v-484eceea]{width:160px;height:160px;top:130px;left:50px}[dir=ltr] .illustration.three[data-v-484eceea]{left:50px}[dir=rtl] .illustration.three[data-v-484eceea]{right:50px}.illustration.four[data-v-484eceea]{width:210px;height:210px;bottom:-40px;left:250px}[dir=ltr] .illustration.four[data-v-484eceea]{left:250px}[dir=rtl] .illustration.four[data-v-484eceea]{right:250px}.illustration.five[data-v-484eceea]{border-radius:15px;width:60px;height:60px;bottom:-30px}[dir=ltr] .illustration.five[data-v-484eceea]{right:10px}[dir=rtl] .illustration.five[data-v-484eceea]{left:10px}.title-default[data-v-484eceea]{padding:0 32px}.title-primary[data-v-484eceea]{font-size:48px;line-height:62px;font-family:\"Roboto Condensed\";text-transform:capitalize;font-weight:700;margin-bottom:64px;position:relative}.theme--dark .title-primary[data-v-484eceea]{color:var(--v-primarylight-base)}.theme--light .title-primary[data-v-484eceea]{color:var(--v-primarydark-base)}@media(max-width:1279px){.title-primary[data-v-484eceea]{font-size:38px;line-height:50px}}@media(max-width:959px){.title-primary[data-v-484eceea]{text-align:center;margin-bottom:32px}}@media(max-width:599px){.title-primary[data-v-484eceea]{font-size:32px;line-height:42px}}.title-secondary[data-v-484eceea]{color:var(--v-secondarydark-base);font-size:48px;line-height:62px;font-family:\"Roboto Condensed\";text-transform:capitalize;font-weight:700;margin-bottom:64px;position:relative}@media(max-width:1279px){.title-secondary[data-v-484eceea]{font-size:38px;line-height:50px}}@media(max-width:599px){.title-secondary[data-v-484eceea]{font-size:32px;line-height:42px}}.title-deco[data-v-484eceea],.title-deco h3[data-v-484eceea]{position:relative}.title-deco h3[data-v-484eceea]{font-family:\"Roboto Condensed\";color:#fff;width:120px;text-transform:capitalize;font-size:48px;font-Weight:700;line-height:62px}[dir=ltr] .title-deco h3[data-v-484eceea]{padding-left:20px}[dir=rtl] .title-deco h3[data-v-484eceea]{padding-right:20px}@media(min-width:1280px){.title-deco h3[data-v-484eceea]{height:160px}[dir=ltr] .title-deco h3[data-v-484eceea]{margin-left:24px}[dir=rtl] .title-deco h3[data-v-484eceea]{margin-right:24px}}@media(min-width:960px){.title-deco h3[data-v-484eceea]{padding-top:40px;margin-top:80px}}@media(min-width:960px)and (max-width:1279px){[dir=ltr] .title-deco h3[data-v-484eceea]{margin-left:56px}[dir=rtl] .title-deco h3[data-v-484eceea]{margin-right:56px}}@media(max-width:1279px){.title-deco h3[data-v-484eceea]{font-size:38px;line-height:50px}}@media(max-width:959px){.title-deco h3[data-v-484eceea]{width:auto;text-align:center}[dir=ltr] .title-deco h3[data-v-484eceea]{padding-left:0}[dir=rtl] .title-deco h3[data-v-484eceea]{padding-right:0}.theme--dark .title-deco h3[data-v-484eceea]{color:var(--v-primarylight-base)}.theme--light .title-deco h3[data-v-484eceea]{color:var(--v-primarydark-base)}}@media(max-width:599px){.title-deco h3[data-v-484eceea]{font-size:32px;line-height:42px}}.title-deco[data-v-484eceea]:before{content:\"\";width:210px;height:210px;background:var(--v-primary-base);border-radius:24px;position:absolute;top:0}[dir=ltr] .title-deco[data-v-484eceea]:before{left:0}[dir=rtl] .title-deco[data-v-484eceea]:before{right:0}.v-application--is-rtl .title-deco[data-v-484eceea]:before{transform:rotate(-45deg)}.v-application--is-ltr .title-deco[data-v-484eceea]:before{transform:rotate(45deg)}@media(max-width:1279px){[dir=ltr] .title-deco[data-v-484eceea]:before{left:24px}[dir=rtl] .title-deco[data-v-484eceea]:before{right:24px}}@media(max-width:959px){.title-deco[data-v-484eceea]:before{display:none}}@media(min-width:1280px){.title-icon-deco[data-v-484eceea]{width:350px}}.title-icon-deco[data-v-484eceea]:before{content:\"\";width:480px;height:480px;border-radius:24px;position:absolute;top:120px}.theme--dark .title-icon-deco[data-v-484eceea]:before{background:#303030}.theme--light .title-icon-deco[data-v-484eceea]:before{background:#fff}.v-application--is-rtl .title-icon-deco[data-v-484eceea]:before{transform:rotate(-45deg)}.v-application--is-ltr .title-icon-deco[data-v-484eceea]:before{transform:rotate(45deg)}[dir=ltr] .title-icon-deco[data-v-484eceea]:before{right:80px}[dir=rtl] .title-icon-deco[data-v-484eceea]:before{left:80px}@media(max-width:959px){.title-icon-deco[data-v-484eceea]:before{display:none}}.theme--dark .title-icon-deco.extend[data-v-484eceea]:before{box-shadow:-30px 20px 0 0 var(--v-secondarydark-base)}.theme--light .title-icon-deco.extend[data-v-484eceea]:before{box-shadow:-30px 20px 0 0 var(--v-secondarylight-base)}.title-icon-deco h3[data-v-484eceea]{font-weight:700;text-transform:capitalize;width:200px;min-height:120px;font-family:\"Roboto Condensed\";font-size:48px;line-height:62px;position:relative}.theme--dark .title-icon-deco h3[data-v-484eceea]{color:var(--v-primarylight-base)}.theme--light .title-icon-deco h3[data-v-484eceea]{color:var(--v-primarydark-base)}@media(max-width:1279px){.title-icon-deco h3[data-v-484eceea]{font-size:38px;line-height:50px;width:100%;text-align:center}}@media(max-width:599px){.title-icon-deco h3[data-v-484eceea]{font-size:32px;line-height:42px}}.title-icon-deco .icon[data-v-484eceea]{position:relative;font-size:100px!important;color:var(--v-secondarylight-base);display:block;margin:16px 0 24px}[dir=ltr] .title-icon-deco .icon[data-v-484eceea]{text-align:left}[dir=rtl] .title-icon-deco .icon[data-v-484eceea]{text-align:right}@media(max-width:1279px){.title-icon-deco .icon[data-v-484eceea]{display:none}}", ""]);
// Exports
module.exports = exports;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./pages/Espacio.vue?vue&type=template&id=484eceea&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._ssrNode("<div class=\"main-wrap\" data-v-484eceea>","</div>",[_c('main-header'),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"container-wrap\" data-v-484eceea>","</div>",[_c('square-parallax'),_vm._ssrNode(" "),_vm._ssrNode("<section id=\"home\" data-v-484eceea>","</section>",[_c('video-banner',{attrs:{"img":_vm.url_base+ _vm.imgFotoEspacio}})],1),_vm._ssrNode(" "),_vm._ssrNode("<section data-v-484eceea>","</section>",[_vm._ssrNode("<div class=\"root1\" data-v-484eceea>","</div>",[_c('v-container',{staticClass:"fixed-width"},[_c('div',{staticClass:"massonry"},[_c('u-animate-container',[_c('v-row',[_c('v-col',{staticClass:"illu-wrap",attrs:{"md":"6","cols":"12"}},[_c('hidden',{attrs:{"point":"smDown"}},[_c('div',{staticClass:"illustration one"}),_vm._v(" "),_c('figure',{staticClass:"illustration two"},[_c('img',{attrs:{"src":_vm.imagnes_uno,"alt":"about"}})]),_vm._v(" "),_c('br'),_vm._v(" "),_c('figure',{staticClass:"illustration three"},[_c('img',{attrs:{"src":_vm.imagnes_uno,"alt":"about"}})]),_vm._v(" "),_c('br'),_vm._v(" "),_c('figure',{staticClass:"illustration four"},[_c('img',{attrs:{"src":_vm.imagnes_uno,"alt":"about"}})]),_vm._v(" "),_c('div',{staticClass:"illustration five"})])],1),_vm._v(" "),_c('v-col',{attrs:{"md":"6","cols":"12"}},[_c('u-animate',{attrs:{"offset":-100,"delay":"0.2s","name":"fadeInRight","duration":"0.6s"}},[_c('div',[_c('div',{staticClass:"title-about"},[_c('h3',{staticClass:"use-text-title"},[_c('span',[_vm._v("objetivo")])])]),_vm._v(" "),_c('p',{staticClass:"use-text.paragraph"},[_vm._v("\n                                    La problemática que se desea trabajar es la falta de oportunidades que tiene la juventud en todos los ámbitos del desarrollo personal, con la desvalorización de la cultura, la falta de formación, experiencia laboral, desarrollo de habilidades y destrezas.\n                                    ")])])])],1)],1)],1)],1)])],1)]),_vm._ssrNode(" "),_vm._ssrNode("<section data-v-484eceea>","</section>",[_c('mision',{attrs:{"mision":_vm.MisonEspacio,"vision":_vm.VisionEspacio}})],1),_vm._ssrNode(" <br data-v-484eceea><br data-v-484eceea><br data-v-484eceea> "),_vm._ssrNode("<section data-v-484eceea>","</section>",[_c('center',[_c('u-animate-container',[_c('v-col',{attrs:{"md":"6","cols":"12"}},[_c('u-animate',{attrs:{"offset":-100,"name":"fadeInLeftShort","delay":"0.2s","duration":"0.3s"}},[_c('div',{staticClass:"blog-wrap"},[_c('article',{staticClass:"px-2"},[_c('h3',{staticClass:"use-text-title2"},[_vm._v("\n             Historia\n            ")]),_vm._v(" "),_c('p',{staticClass:"use-text-paragraph"},[_vm._v("\n            "+_vm._s(_vm.historia)+"            \n              ")])])])])],1)],1)],1)],1),_vm._ssrNode(" <br data-v-484eceea><br data-v-484eceea><br data-v-484eceea> "),_c('v-container',{class:{ 'fixed-width': _vm.mdUp }},[_c('u-animate-container',[_c('v-row',{staticClass:"spacing6"},[_c('v-col',{staticClass:"pa-6",attrs:{"cols":"12","md":"3"}},[_c('u-animate',{attrs:{"offset":-100,"name":"fadeInLeftShort","delay":"0.2s","duration":"0.3s"}},[_c('div',{staticClass:"side-filter"},[_c('h4',{staticClass:"title-primary"},[_vm._v("\n                Galeria\n                ")])])])],1),_vm._v(" "),_c('v-col',{staticClass:"pa-6",attrs:{"cols":"12","md":"9"}},[_c('div',{staticClass:"massonry"},[_c('v-row',{attrs:{"no-gutters":""}},[_vm._l((_vm.itemFotosEspacios),function(item){return _c('v-col',{key:item.id_fotoeventoespacio,staticClass:"pa-3",attrs:{"cols":"12","sm":"4","md":"4"}},[_c('u-animate',{attrs:{"name":"fadeInUpShort","delay":"0.2s","duration":"0.4s"}},[_c('div',[_c('card-galeria',{attrs:{"bg":_vm.url_base+item.photo,"title":item.nombre_foto,"size":"mediun","show-img":function () { return _vm.showImg(item.id_fotoeventoespacio); }}})],1)])],1)}),_vm._v(" "),_c('v-col',{staticClass:"pa-3",attrs:{"cols":"6","sm":"4","md":"4"}},[_c('u-animate',{attrs:{"delay":(_vm.itemFotosEspacios.length * 0.2) + 's',"name":"fadeInUpShort","duration":"0.4s"}},[_c('div',{staticClass:"card-wrap"},[_c('span',{staticClass:"fold"}),_vm._v(" "),_c('card-galeria',{attrs:{"bg":"/images/iconofotos.png","title":"mdsas fotos","size":"mediun","simple":false,"show-img":function () { return _vm.IraTodasFotos(); }}}),_vm._v(" "),_c('span',{staticClass:"property"},[_c('span',{staticClass:"title-category"},[_vm._v("Todos los Fotos")]),_vm._v(" "),_c('v-icon',[_vm._v("mdi-arrow-right")])],1)],1)])],1)],2)],1)])],1),_vm._v(" "),_c('v-row',{staticClass:"spacing6"},[_c('v-col',{staticClass:"pa-6",attrs:{"cols":"12","md":"3"}},[_c('u-animate',{attrs:{"offset":-100,"name":"fadeInLeftShort","delay":"0.2s","duration":"0.3s"}},[_c('div',{staticClass:"side-filter"},[_c('h4',{staticClass:"title-primary"},[_vm._v("\n                Videos\n                ")])])])],1),_vm._v(" "),_c('v-col',{staticClass:"pa-6",attrs:{"cols":"12","md":"9"}},[_c('div',{staticClass:"massonry"},[_c('v-row',{attrs:{"no-gutters":""}},[_vm._l((_vm.itemvideos),function(item){return _c('v-col',{key:item.id_videoventoespacio,staticClass:"pa-3",attrs:{"cols":"12","sm":"4","md":"4"}},[_c('u-animate',{attrs:{"name":"fadeInUpShort","delay":"0.2s","duration":"0.4s"}},[_c('div',[_c('card-galeria',{attrs:{"bg":"/images/youtubeone.png","title":item.nombre_video,"size":"mediun","show-img":function () { return _vm.handleVideoOpen(item.idvideo); }}})],1)])],1)}),_vm._v(" "),_c('v-col',{staticClass:"pa-3",attrs:{"cols":"6","sm":"4","md":"4"}},[_c('u-animate',{attrs:{"delay":(_vm.itemvideos.length * 0.2) + 's',"name":"fadeInUpShort","duration":"0.4s"}},[_c('div',{staticClass:"card-wrap"},[_c('span',{staticClass:"fold"}),_vm._v(" "),_c('card-galeria',{attrs:{"bg":"/images/youtubeone.png","title":"mdsas fotos","size":"mediun","simple":false,"show-img":function () { return _vm.IraVideos(); }}}),_vm._v(" "),_c('span',{staticClass:"property"},[_c('span',{staticClass:"title-category"},[_vm._v("Todos los Videos")]),_vm._v(" "),_c('v-icon',[_vm._v("mdi-arrow-right")])],1)],1)])],1)],2)],1)])],1),_vm._v(" "),_c('v-row',{staticClass:"spacing6"},[_c('v-col',{staticClass:"pa-6",attrs:{"cols":"12","md":"3"}},[_c('u-animate',{attrs:{"offset":-100,"name":"fadeInLeftShort","delay":"0.2s","duration":"0.3s"}},[_c('div',{staticClass:"side-filter"},[_c('h4',{staticClass:"title-primary"},[_vm._v("\n                Noticias\n                ")])])])],1),_vm._v(" "),_c('v-col',{staticClass:"pa-6",attrs:{"cols":"12","md":"9"}},[_c('div',{staticClass:"massonry"},[_c('v-row',{attrs:{"no-gutters":""}},[_vm._l((_vm.itemNoticias),function(item){return _c('v-col',{key:item.id_noticiaeventoespacio,staticClass:"pa-3",attrs:{"cols":"12","sm":"4","md":"4"}},[_c('u-animate',{attrs:{"name":"fadeInUpShort","delay":"0.2s","duration":"0.4s"}},[_c('div',[_c('card-galeria',{attrs:{"bg":_vm.url_base+item.photo,"title":item.titulo,"size":"mediun","show-img":function () { return _vm.showImg2(item.id_noticiaeventoespacio); }}})],1)])],1)}),_vm._v(" "),_c('v-col',{staticClass:"pa-3",attrs:{"cols":"6","sm":"4","md":"4"}},[_c('u-animate',{attrs:{"delay":(3 * 0.2) + 's',"name":"fadeInUpShort","duration":"0.4s"}},[_c('div',{staticClass:"card-wrap"},[_c('span',{staticClass:"fold"}),_vm._v(" "),_c('card-galeria',{attrs:{"bg":"/images/iconofotos.png","title":"mdsas fotos","size":"mediun","simple":false,"show-img":function () { return _vm.IraTodasNoticias(); }}}),_vm._v(" "),_c('span',{staticClass:"property"},[_c('span',{staticClass:"title-category"},[_vm._v("Todos las Noticias")]),_vm._v(" "),_c('v-icon',[_vm._v("mdi-arrow-right")])],1)],1)])],1)],2)],1)])],1)],1)],1),_vm._ssrNode(" <br data-v-484eceea><br data-v-484eceea>")],2),_vm._ssrNode(" "),_c('hidden',{attrs:{"point":"mdDown"}},[_c('page-nav')],1),_vm._ssrNode(" "),_c('main-footer')],2),_vm._ssrNode(" "),(_vm.loaded)?_c('vue-easy-lightbox',{attrs:{"visible":_vm.visible,"imgs":_vm.imgs,"index":_vm.index},on:{"hide":_vm.handleHide}}):_vm._e(),_vm._ssrNode(" "),(_vm.loaded2)?_c('vue-easy-lightbox',{attrs:{"visible":_vm.visible2,"imgs":_vm.imgs2,"index":_vm.index2},on:{"hide":_vm.handleHide2}}):_vm._e(),_vm._ssrNode(" "),_c('v-dialog',{attrs:{"max-width":"690"},model:{value:(_vm.dialog),callback:function ($$v) {_vm.dialog=$$v},expression:"dialog"}},[_c('v-card',{staticClass:"video-popup"},[_c('v-card-title',{staticClass:"headline"},[_c('h2',{staticClass:"title-main"},[_vm._v("\n           video\n          "),_c('v-btn',{attrs:{"icon":""},on:{"click":function($event){return _vm.handleVideoClose()}}},[_c('v-icon',[_vm._v("mdi-close")])],1)],1)]),_vm._v(" "),(_vm.yt)?_c('div',{staticClass:"text-center"},[_c('youtube',{ref:"youtube",attrs:{"video-id":_vm.videoId,"player-vars":_vm.playerVars,"width":640,"height":360}})],1):_vm._e()],1)],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/Espacio.vue?vue&type=template&id=484eceea&scoped=true&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/Espacio.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var Espaciovue_type_script_lang_js_ = ({
  components: {
  ...
  methods: {
    ...
    showImg(idfoto) {
      this.index = this.itemFotosEspacios.findIndex(x => x.id_fotoeventoespacio == idfoto);
      this.visible = true;
    },
    ...
    showImg2(idfoto) {
      this.index2 = this.itemNoticias.findIndex(x => x.id_noticiaeventoespacio == idfoto);
      this.visible2 = true;
    },
...
// CONCATENATED MODULE: ./pages/Espacio.vue?vue&type=script&lang=js&
 /* harmony default export */ var pages_Espaciovue_type_script_lang_js_ = (Espaciovue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(9);
...
// CONCATENATED MODULE: ./pages/Espacio.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  pages_Espaciovue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var Espacio = __webpack_exports__["default"] = (component.exports);
...
//# sourceMappingURL=Espacio.js.map